    ...
    return {
        init: function() {
            ...
            $("#progress-wizard").bind('step_shown', function(event, data){
                if(data.currentStep == 'progress-five'){
                    $(".button_wizad_contanat_change").html('Submit');
                }else{
                    $(".button_wizad_contanat_change").html('Next');
                }
		if (data.currentStep === 'progress-first') {
                ...
                else if (data.currentStep === 'progress-four') {
                    progressBar
                        .css('width', '80%')
                ...
                else if (data.currentStep === 'progress-five') {
                    progressBar
                        .css('width', '100%')
