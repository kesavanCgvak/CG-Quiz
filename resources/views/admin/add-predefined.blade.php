...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    ...
                    <form action="{{ url('add-prequestions') }}" method="post" class="form-horizontal form-bordered"
                          id="add_prequestions">
                        {{ csrf_field() }}
    ...
    <script>
        $(function () {
                $('#add_prequestions').validate({ // initialize the plugin
                    rules: {
                        group_name: {
                            required: true
                        },
                ...
                $("[name^=predefined_questions]").each(function () {
                    $(this).rules("add", {
                        required: true,
                    });
                });
